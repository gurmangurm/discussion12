...
// Question 1
document.querySelector("#host-name").innerText = "Gurman Gurm";
document.querySelector("#collaborator-name").innerText = "XYZ";
...
firstNameInput.addEventListener("input", function()  {
    if (firstNameInput.value.toLowerCase() === "John") {
        ...
        lastNameInput.value = ""; // Optionally clear if the name is not "John"
    }
});
